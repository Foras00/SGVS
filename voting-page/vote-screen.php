                    ...
                    ?>
                        <div class="card" name="card" id="card">
                            ...
                            <ul class="card-content">
                                ...
                                <form method="POST" class="chb" action="">
                                    <input type="" value="<?php echo $pres_row['id']; ?>" name="candId" style="visibility: hidden;">
                                    <input type="submit" class="sad" name="inputpress" value="<?php echo $pres_row['id']; ?>">
                                </form>
                            </ul>
                        </div>
                        ...
                        <div class="card" name="card" id="card">
                            ...
                            <ul class="card-content">
                                ...
                                <form method="POST" action="">
                                    <input type="" value="<?php echo $vpres_row['id']; ?>" name="candId" style="visibility: hidden;">
                                    <input type="submit" class="sad" name="inputpress" value="SubmitVote">
                                </form>
                            </ul>
                        </div>
                        <!-- this closing bracket ends the while loop -->
                    ...
                    ?>
                        <div class="card" name="card" id="card">
                            ...
                            <ul class="card-content">
                                ...
                                <form method="POST" action="">
                                    <input type="" value="<?php echo $councilor_row['id']; ?>" name="candId" style="visibility: hidden;">
                                    <input type="submit" class="sad" name="inputpress" value="SubmitVote">
                                </form>
                            </ul>
                        </div>
                    ...
                    ?>
                        <div class="card" name="card" id="card">
                            ...
                            <ul class="card-content">
                                ...
                                <form method="POST" action="">
                                    <input type="" value="<?php echo $secretary_row['id']; ?>" name="candId" style="visibility: hidden;">
                                    <input type="submit" class="sad" name="inputpress" value="SubmitVote">
                                </form>
                            </ul>
                        </div>
                    ...
                    ?>
                        <div class="card" name="card" id="card">
                            ...
                            <ul class="card-content">
                                ...
                                <form method="POST" action="">
                                    <input type="" value="<?php echo $auditor_row['id']; ?>" name="candId" style="visibility: hidden;">
                                    <input type="submit" class="sad" name="inputpress" value="SubmitVote">
                                </form>
                            </ul>
                        </div>
                    ...
                    ?>
                        <div class="card" name="card" id="card">
                            ...
                            <ul class="card-content">
                                ...
                                <form method="POST" action="">
                                    <input type="" value="<?php echo $treasurer_row['id']; ?>" name="candId" style="visibility: hidden;">
                                    <input type="submit" class="sad" name="inputpress" value="SubmitVote">
                                </form>
                            </ul>
                        </div>
